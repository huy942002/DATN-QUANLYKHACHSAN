...
import { getAllFacilities, getFacilitiesById, update, add } from '~/app/reducers/facilities';
...
const FacilitySchema = Yup.object().shape({
    name: Yup.string().required('Tên Cơ sở vật chất không được để trống'),
...
function Facilities() {
    ...
    const [facilitiex, setFacilities] = useState(objFacilities);
    ...
    function handleUpdateFaci(dataFaci) {
        setFacilities(dataFaci);
        dispatch(update(facilitiex));
