...
import { getByRoomIdSv, UpdateRoom } from '~/app/reducers/room';
...
function RoomManage() {
    ...
    const ServiceAva = useSelector((state) => state.room.ServiceAvailables);
            ...
            <div className="grid mt-2  rounded-full text-white">
                ...
                <div className="grid grid-cols-3 gap-3 mt-6 ml-8 text-black">
                    ...
                    <div>
                        ...
                        <select name="KindOfRoom" id="KindOfRoom" className="w-40 p-1 rounded">
                        ...
                        <Modal.Body>
                            <div className="text-center">
                                ...
                                <div className="flex justify-center gap-4">
                                    ...
                                    >
                                        <Link to={config.routes.createRoomManager}>Thêm 1 Phòng</Link>
                                    </Button>
                                    <Button color="gray" onClick={() => setVisibleDelete(false)}>
                                        <Link to={config.routes.createOptionRoomManager}>Thêm Nhiều Phòng</Link>
                                    </Button>
                                </div>
                            </div>
                        </Modal.Body>
                            ...
                            {rooms
                                ...
                                .map((x) => (
                                    ...
                                    >
                                        ...
                                        <td className="py-4 px-6">{x.kindOfRoom.prices_by_day}</td>
                                        <td className="py-4 px-6">{x.kindOfRoom.hourly_prices}</td>
                                        <td className="py-4 px-6 ">
                                            {x.status === 1 ? (
                                                <label
                                                    htmlFor=""
                                                    className="rounded-full dark:text-gpy-2 px-3 text-sm font-medium bg-lime-500"
                                                />
                                            ) : (
                                                <label
                                                    htmlFor=""
                                                    className="rounded-full dark:text-gpy-2 px-3 text-sm font-medium bg-red-500"
                                                />
                                            )}
                                        </td>
                                        <td className="py-4 px-6 ">
                                            <button
                                                ...
                                                className="py-2 px-2 text-sm font-medium text-center text-white bg-violet-400 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
                                            >
