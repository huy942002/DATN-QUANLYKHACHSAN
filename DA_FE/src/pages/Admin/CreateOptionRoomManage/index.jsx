...
function CreateOptionRoomManager() {
    ...
    const addRoom = async (data, datasl) => {
        ...
        const response = await axios.post('http://localhost:8080/api/room/Option/' + datasl, {
            rooms: roomAdd,
                    ...
                    <form>
                        <div className="text-black">
                            <div className="grid grid-cols-2 text-black">
                                <div><label
                                    htmlFor=""
                                    className="mt-8 mr-3 text-gray-900 dark:text-gray-300 font-bold"
                                >
                                    Số Phòng muốn tạo :
                                </label>
                                    <input
                            ...
                            <div className="grid grid-cols-2 text-black">
                                <div className='mt-8'>
                                    <label
                                        htmlFor=""
                                        className="mb-2 mr-7 text-gray-900 dark:text-gray-300 font-bold"
                                    >
                                        Số Tầng  :
                                    </label>
                                    <input
                                        ...
                                        disabled={true}
                                        className="mb-2 mr-7 w-40 p-1 text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
