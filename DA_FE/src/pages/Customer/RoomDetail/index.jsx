...
import { faCheck, faChevronRight, faDoorOpen, faTree, faWifi } from '@fortawesome/free-solid-svg-icons';
        ...
        <div>
            ...
            <div className="grid grid-cols-3 gap-6 mx-36 mt-10">
                <div className="col-start-1 col-end-3 border-2 border-slate-200 rounded-md p-5">
                    ...
                    <h5 className="font-bold text-xl text-red-500 mt-6">Giá phòng : 5,000,000đ</h5>
                </div>
                            ...
                            <div className="col-start-2 col-end-4">
                                ...
                                >
                                    <span className="mx-2 block">
                                        <Link to={config.routes.searchRoom}>Đặt phòng ngay</Link>
                                    </span>
                                </button>
                            </div>
                        </div>
