...
(
ID INT IDENTITY(1,1) NOT NULL,
NAME_FACILITIES NVARCHAR(30) NOT NULL,
STATUS INT NOT NULL
...
(
ID INT IDENTITY(1,1) NOT NULL,
NAME_OF_RENTAL_TYPE NVARCHAR(30) NOT NULL,
STATUS INT NOT NULL
...
(
ID INT IDENTITY(1,1) NOT NULL,
NAME_PAYMENT_TYPE NVARCHAR(15) NOT NULL,
STATUS INT NOT NULL
...
(
ID INT IDENTITY(1,1) NOT NULL,
NAME_BOOKINGTYPE NVARCHAR(30) NOT NULL,
STATUS INT NOT NULL
...
(
ID INT IDENTITY(1,1) NOT NULL,
NAME_SERVICES_TYPE NVARCHAR(20) NOT NULL,
...
(
ID INT IDENTITY(1,1) NOT NULL,
NAME_SERVICES NVARCHAR(20) NOT NULL,
...
CONSTRAINT FK_ID_DETAILS_INVOICES FOREIGN KEY (ID_DETAILS_INVOICE) REFERENCES DETAILS_INVOICE
)
